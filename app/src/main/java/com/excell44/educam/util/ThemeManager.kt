...
class ThemeManager @Inject constructor(
    ...
    enum class ThemeColor(
        ...
        // 5. Tech Spectrum - Modern digital aesthetic
        TECH_SPECTRUM(
            Brush.linearGradient(
                colors = listOf(
            ...
            Color(0xFF10B981),
            "Tech Spectrum",
            "Modern digital innovation suite"
        ),
    ...
    fun getThemeColor(): ThemeColor {
        val index = prefs.getInt("theme_color", ThemeColor.DEFAULT_THEME_INDEX)
        return ThemeColor.fromIndex(index)
    }

    fun getThemeColorIndex(): Int {
        return prefs.getInt("theme_color", ThemeColor.DEFAULT_THEME_INDEX)
    }
